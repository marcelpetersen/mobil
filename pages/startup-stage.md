        ...
        <div class="col-lg-10 offset-lg-2">
          <section class="mt-5">
            ...
            <div class="content-dropdown faq">
              ...
              <div class="content-dropdown__content">
                <p class="pr-5 mt-3">Applications are open till September 25 at noon. After that, we'll evaluate them with our jury. If you are a finalist, we'll get in touch with you by mid of October at the latest.</p>
              </div>
              <div class="content-dropdown__opener">
                <a class="with-down-arrow"></a>
              </div>
