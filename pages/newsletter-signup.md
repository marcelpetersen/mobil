...
<div class="jumbotron d-flex flex-column justify-content-center" style="min-height: 40vh;">
  ...
  <h2>Subscribe to the WunderBar Newsletter</h2>


  <div class="mx-auto clearfix" style="max-width:500px">
    <p class=" mb-4 mt-3">For the latest updates from Wunder HQ, insights into the future of mobility and news about events, subscribe now!</p>
